...
const RevisionForm = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_m39u4t1', 'template_y6rzaga', e.target, '9Iv1gFcW2SqXdaGMF')
          .then((result) => {
    ...
    <div className="w-full font-[Poppins] ">
        ...
        <form className='max-w-[650px] border-2 border-yellow-400 mx-auto bg-black bg-opacity-40 p-5' id='revisionForm' onSubmit={sendEmail}>
            ...
            <div className="flex flex-wrap items-center justify-center space-y-10 md:space-y-0 md:flex-nowrap md:space-x-5">
                <div className="max-w-[300px] border-2 border-gray-300 rounded-md ">
            ...
            <div className="flex items-center justify-center mt-10">
                <div className="max-w-[300px] border-2 border-gray-300 rounded-md ">
                    <input type="text" className='w-[300px] p-3 bg-transparent text-yellow-400 placeholder-yellow-400 outline-none h-[50px] text-sm ' name='subject' value='Revisioning Your Life' readOnly placeholder='Subject: Revisioning Your Life' />
                </div>
            </div>
            ...
            <div className="flex items-center mt-10 justify-center">
                <button type='submit' form='revisionForm' className="border-2 border-gray-300 font-semibold text-lg py-2 px-4 cursor-pointer text-gray-300 hover:text-yellow-400 hover:border-yellow-400 transition duration-500">Send message</button>
            </div>
