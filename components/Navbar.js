      ...
      <div className='md:flex items-center justify-between bg-black py-2 md:px-10 px-4'>
          <a href="/">
                <div className='font-bold text-2xl cursor-pointer flex items-center '>
                    ...
                    <motion.div className="text-white pt-[3px] text-2xl md:text-4xl name-font ml-2 font-semibold" initial='hidden' animate='visible'
                        variants={{
                            hidden: {
                                scale: 1,
                                opacity: 0
            ...
            <ul className={`pb-12 absolute pt-8 bg-black z-[-1] left-0 w-full lg:flex lg:items-center lg:justify-end lg:pb-0 lg:w-[max-content] lg:pt-0 lg:static lg:z-20 lg:pl-0 pl-2 transition-all duration-500 ease-in ${open ? 'top-10 ':'top-[-320px]'}`}>
                ...
                <a href="/elevated-life" className="md:ml-5 text-lg  my-7">
                    <motion.li className="text-yellow-400  hover:text-yellow-200 font-semibold my-7 md:my-0 duration-500 " initial='hidden' animate='visible' variants={{
                        hidden: {
                            scale: 1,
                            opacity: 0
                        },
                ...
                <a href="/story-revision" className="md:ml-5 text-lg  my-7">
                    ...
                    }} >Story Revision</motion.li>
                </a>
    
                <a href="/about-me" className="md:ml-5 text-lg  my-7">
                    <motion.li className="text-yellow-400  hover:text-yellow-200 font-semibold my-7 md:my-0 mr-5 duration-500 " initial='hidden' animate='visible' variants={{
                        hidden: {
                            scale: 1,
                            opacity: 0
                        },
