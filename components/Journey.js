	...
	return (
		<div className='h-[max-content] pr-2 bg-white relative py-[2rem] md:py-[3rem] w-full'>
			...
			<div className='md:flex md:items-center md:justify-center w-full md:pr-5 md:py-5 pr-2 py-2 '>
				<div
					ref={textRef}
					className='h-[400px] md:h-[500px] xl:h-[600px] w-full 2xl:h-[700px] -mt-[4rem] md:-mt-0 relative '>
				...
				<div className='font-[Poppins] xl:pl-[5rem] -mt-[3rem] md:mt-0 w-full'>
					...
					<p className='my-6 md:my-8 md:text-lg text-gray-400 max-w-[750px] ml-5 '>
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum placeat quia soluta rem non
						consequuntur eveniet, cupiditate tenetur animi aliquid molestias incidunt culpa laborum labore
						veritatis. Animi incidunt illum architecto.
					</p>
					...
					<div className='flex w-full items-center xl:-ml-[5rem] justify-center mb-5 '>
						<button className='font-[Poppins] text-lg text-black md:text-xl border-2 border-yellow-400 py-2 px-4 font-semibold hover:bg-black hover:text-yellow-400 transition duration-500 mt-2 '>
							More About Me
						</button>
					</div>
				</div>
