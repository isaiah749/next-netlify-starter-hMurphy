		...
		<div className='h-[max-content] px-2 relative py-[3rem] w-full'>
			<div className='flex items-center pb-2 md:pb-0 md:my-8 lg:my-5 justify-center'>
				...
				<motion.div initial='hidden' animate={titleAnimation}>
					<h1 className='text-center text-2xl text-white sm:text-5xl title-font font-bold '>
						Rewrite Your Story
					</h1>
				</motion.div>
			...
			<div className='md:flex md:items-center md:justify-center w-full md:px-5 md:py-5 px-2 py-2 '>
				...
				<div className='font-[Poppins] mt-5 md:mt-0 w-full'>
					...
					<p className='my-4 md:my-8 md:text-lg text-gray-200 max-w-[750px] ml-5 '>
					...
					<div className='flex w-full items-center xl:-ml-[5rem] justify-center mb-5 '>
						<a href='/story-revision' className=''>
							<button className='font-[Poppins] text-lg text-yellow-400 md:text-xl border-2 border-yellow-400 py-2 px-4 font-semibold hover:bg-yellow-400 hover:text-black transition duration-500 ml-5 '>
								Learn More
							</button>
						</a>
					</div>
